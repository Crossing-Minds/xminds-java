...
public class ServerException extends XMindException {
	...
	public ServerException(String msg, String code, int httpStatus, int retryAfter) {
		super(msg, code, httpStatus, retryAfter);
	}

	public ServerException(Throwable throwable, String msg, String code, int httpStatus, int retryAfter) {
